...
urlpatterns = [
    ...
    re_path('document/view_docx/(.+)/$', document_views.view_docx, name="view_docx"),
    re_path('document/fill_docx/(.+)/(.+)/$', document_views.fill_docx, name="fill_docx"),
    re_path('document/fill_signature/', document_views.fill_signature, name="fill_signature"),
    ...
    re_path('document/supervisor_signature/', document_views.supervisor_signature, name="supervisor_signature"),
]
