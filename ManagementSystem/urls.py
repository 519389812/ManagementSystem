...
urlpatterns = [
    ...
    path(r'register_verify_email/', user_views.register_verify_email, name="register_verify_email"),
    path(r'send_register_verify_email/', user_views.send_register_verify_email, name="send_register_verify_email"),
    path(r'reset_password_email/', user_views.reset_password_email, name="reset_password_email"),
    path(r'send_reset_password_email/', user_views.send_reset_password_email, name="send_reset_password_email"),
    re_path(r'verify_register_email/(.*)/$', user_views.verify_register_email, name="verify_register_email"),
    re_path(r'reset_password/(.*)/$', user_views.reset_password, name="reset_password"),
