    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.TextField(blank=True, max_length=10000, verbose_name='签名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.TextField(blank=True, max_length=10000, verbose_name='签名')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('docx', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='document.docxinit', verbose_name='模板')),
            ],
            options={
                'verbose_name': '签名',
